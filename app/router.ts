...
import {getUsers, getUser, putUpdatedUser, deleteDeleteUser, postClearSession} from './controllers/user.controller';
import {
...
export function createRouter(): Router {
  ...
  router.post('/users/:userId/clearSession', adminRoleRequired, asyncWrapper(postClearSession));
