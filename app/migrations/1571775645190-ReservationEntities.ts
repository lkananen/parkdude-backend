...
export class ReservationEntities1571775645190 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(`CREATE TABLE "day_release" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "spotId" uuid, CONSTRAINT "PK_156e5720b9115270ff3b609d451" PRIMARY KEY ("id"))`, undefined);
    ...
    await queryRunner.query(`CREATE TABLE "day_reservation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" date NOT NULL, "created" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "spotId" uuid, CONSTRAINT "PK_9ecd3a98cd0c3207ead63219863" PRIMARY KEY ("id"))`, undefined);
    ...
    await queryRunner.query(`ALTER TABLE "parking_spot" ADD "ownerId" integer`, undefined);
