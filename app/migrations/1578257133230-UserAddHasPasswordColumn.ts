...
export class UserAddHasPasswordColumn1578257133230 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(`ALTER TABLE "user" ADD "hasPassword" boolean NOT NULL DEFAULT false`, undefined);
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "hasPassword"`, undefined);
  }
}
